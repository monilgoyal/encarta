...
import * as skillsets from '../data/sponsors'
    ...
    return (
        <>
            ...
            <section id='education' className="text-gray-400 body-font mx-auto mb-4 py-4">
                <div className="container px-5 mx-auto">
                    <div className="flex flex-col text-center w-full mt-4 mb-8">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font  dark:text-white text-indigo-500">Day One</h1>
                    </div>
                    <Education />
                </div>
            </section>
            <section id='education' className="text-gray-400 body-font mx-auto mb-4 py-4">
                <div className="container px-5 mx-auto">
                    <div className="flex flex-col text-center w-full mt-4 mb-8">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font  dark:text-white text-indigo-500">Day Two</h1>
                    </div>
                    <Experience />
                </div>
            </section>
