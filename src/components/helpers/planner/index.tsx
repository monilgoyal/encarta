    ...
    return (
        <>
            <div className="container  mx-auto flex flex-wrap ">
                {day.map((e, index) => (
                    index % 2 === 0 ?
                        <div className="flex  flex-row relative w-full mx-auto overflow-x-hidden text-gray-900  py-10" key={index}>
                        ...
                        <div className="flex flex-row lg:flex-row-reverse relative w-full mx-auto overflow-x-hidden text-gray-900  py-10" key={index} >
