    ...
    return (
        !requested ? <form className="relative" onSubmit={handleSubmit}>
            <div className="flex align-middle">
                ...
                <div>
                    <div className='text-3xl font-semibold dark:text-white'>{formObject.title}</div>
            ...
            <div className="my-0 pt-5 mb-5 -mx-9">
                ...
                <div className='inline-block py-0 px-10 w-full'>
                    ...
                    <div className='my-2'>
                        <input type="text" className={'py-2 border-0 border-b w-full block outline-none border-solid text-sm h-14 bg-transparent dark:border-gray-500 dark:text-gray-200  focus:border-b-2'.concat(' ', errors['email'] || errors['invalidEmail'] ? 'border-red-600 ' : 'border-gray-300 focus:border-gray-400')} placeholder='example@gmail.com'
                            value={email}
                            onChange={(e) => {
